...
def ig_download():
    ...
    # macGoogleChrome driver path:
    # chromedriver = '/usr/local/bin/chromedriver'
    # open chromedriver
    # driver = webdriver.Chrome(chromedriver)

    # windows Google chrome driver: don't need to print path
    ...
    time.sleep(1)
    #   i used to scroll the page to the bottom to save the driver.pageSource, but i failed @@
    # for i in range(0, int(int(numbers[0].text) / 10)):
    ...
    # with open('ig.html', 'w', encoding='utf-8') as file:
